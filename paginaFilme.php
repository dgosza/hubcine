    ...
    <div class="row-fluid">
        <div class="all">
            ...
            foreach($fetchAll as $dados){
                ...
                echo '<h1>'.$dados['filme'].'</h1><br><br>';
                echo ''.$dados['descricao'].'<br><br>';
                echo '<b>Gênero: </b>'.$dados['genero'].'<br>';
                echo '<b>Ano de Lançamento: </b>'.$dados['anoLancamento'].'<br>';
                echo '<b>Faixa Etária: </b>'.$dados['faixaEtaria'].' Anos<br><br>';
                echo '<iframe width="560" height="315" src="'.$dados['trailer'].'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
