...
<body>
    ...
    <div class="row-fluid">
        <div class="all">
            ...
            <div id="meio">
                <div id="slideFilmes" class="carousel slide" data-ride="carousel">
                    
                    <div class="carousel-inner">

                        <div class="carousel-item active">
                            <img class="d-block w-100" src="imgs/venom.jpg" alt="Venom">
                        </div>


                        <div class="carousel-item">
                            <img class="d-block w-100" src="imgs/truedetective.jpeg" alt="Venom">
                        </div>


                        <div class="carousel-item ">
                            <img class="d-block w-100" src="imgs/interstellar.jpg" alt="Venom">
                        </div>
